<template>
    <div class="wrapper rounded bg-white">
        ...
        <form v-on:submit.prevent="onSubmit" method="post" class="body">
            <div class="forms" >
                <div class="row">
                    <div class="col-md-6 ">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 field">
                        ...
                        <input type="password" class="form-control" required v-model="posts.password" name="password">
                    </div>
                    <div class="col-md-6 field">
                ...
                <p class="register">Not a member? <router-link to="/login">Login here!</router-link></p>
            </div>
        </form>
    </div>
</template>
...
export default {
    ...
    methods: {
        async onSubmit() {
            var register = await postRequest('/register', this.posts);
